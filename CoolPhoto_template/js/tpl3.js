...
function playPhoto() {
    ...
    function play() {
        ...
        str += '<div id="ppT9lwFAC-an-obj-1"><img height="815" width="500" src="./img/tpl3/bg.jpg"></div>';
        str += '<div id="ppT9lwFAC-an-obj-5"><img height="130" width="300" src="./img/tpl3/10.png"></div>';
        str += '<div id="ppT9lwFAC-an-obj-7"><img height="206" width="250" src="./img/tpl3/9.png"></div>';
        str += '<div id="ppT9lwFAC-an-obj-8"><img height="206" width="250" src="./img/tpl3/9.png"></div>';
        str += '<div id="ppT9lwFAC-an-obj-9"><img height="206" width="250" src="./img/tpl3/9.png"></div>';
        str += '<div id="ppT9lwFAC-an-obj-10"><img height="206" width="250" src="./img/tpl3/9.png"></div>';
        str += '<div id="ppT9lwFAC-an-obj-11">';
        str += '<div id="ppT9lwFAC-an-obj-12"><img height="44" width="70" src="./img/tpl3/7.png"></div>';
        str += '<div id="ppT9lwFAC-an-obj-13">';
        str += '<img height="213" width="150" src="./img/tpl3/8.png">';
        str += '<img id="eye_1" width="100" src="./img/tpl3/5.png">';
        str += '<img id="eye_2" width="100" src="./img/tpl3/4.png">';
        str += '</div>';
        str += '<div id="ppT9lwFAC-an-obj-14"><img height="130" width="57" src="./img/tpl3/3.png"></div>';
        str += '<div id="ppT9lwFAC-an-obj-15"><img height="190" width="57" src="./img/tpl3/2.png"></div>';
        str += '<div id="ppT9lwFAC-an-obj-16"><img height="44" width="70" src="./img/tpl3/7.png"></div>';
        str += '<div id="ppT9lwFAC-an-obj-17">';
        str += '<img height="194" width="150" src="./img/tpl3/6.png">';
        str += '<img id="eye_3" width="93" src="./img/tpl3/5.png">';
        str += '<img id="eye_4" width="93" src="./img/tpl3/4.png">';
        str += '</div>';
        str += '<div id="ppT9lwFAC-an-obj-18"><img height="130" width="57" src="./img/tpl3/3.png"></div>';
        str += '<div id="ppT9lwFAC-an-obj-19"><img height="190" width="57" src="./img/tpl3/2.png"></div>';
        str += '</div>';
        str += '<div id="ppT9lwFAC-an-obj-20"><img height="100" width="82" src="./img/tpl3/1.png"></div>';
        str += '<div id="ppT9lwFAC-an-obj-21"><img height="100" width="82" src="./img/tpl3/1.png"></div>';
        str += '<div id="ppT9lwFAC-an-obj-22"><img height="100" width="82" src="./img/tpl3/1.png"></div>';
        str += '<div id="ppT9lwFAC-an-obj-23"><img height="100" width="82" src="./img/tpl3/1.png"></div>';
        str += '</div>';
        ...
        function crate_bubbles() {
            for (var i = 0; i < 5; i++) {
                ...
                if (src_rand == 0)
                    circle.src = "./img/tpl3/11.png";
                else
                    circle.src = "./img/tpl3/12.png";
                circle.width = "100";
                circle.height = "100";
